...
namespace FreeCourse.Services.Catalog
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Herhangi bir constructor da IDatabaseSettings refere ettiðimizde configursyon dosyasýndaki value larý doldurarak singleton olarak DatabaseSetting class implemente edecek.
